      ...
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 pt-32 pb-20 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up delay-hero-4 flex-wrap">
            ...
            <Link to="/login" state={{ intendedPath: '/employer' }} className="w-full sm:w-auto px-6 py-3.5 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-300 hover:text-amber-200 rounded-xl font-bold text-base transition-all flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(245,158,11,0.1)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-[#1e293b]/50 border border-slate-800 p-8 rounded-2xl hover:border-indigo-500/50 transition-colors animate-fade-in-up delay-cards-1">
            ...
            <p className="text-slate-400 leading-relaxed text-sm">
              We don't sugarcoat it. Our Groq-powered Llama 3.1 engine scans for technical skills and penalizes missing keywords.
            </p>
          </div>
          ...
          <div className="bg-[#1e293b]/50 border border-slate-800 p-8 rounded-2xl hover:border-rose-500/50 transition-colors animate-fade-in-up delay-cards-2">
            ...
            <p className="text-slate-400 leading-relaxed text-sm">
              If an enterprise ATS can't read your PDF, neither can we. We test for machine readability locally.
            </p>
          </div>

          <div className="bg-[#1e293b]/50 border border-slate-800 p-8 rounded-2xl hover:border-amber-500/50 transition-colors animate-fade-in-up delay-cards-3">
            ...
            <h3 className="text-xl font-bold text-white mb-3">B2B Portal Pipeline</h3>
            <p className="text-slate-400 leading-relaxed text-sm">
              Target exact open roles from our simulated partner companies. Admins track pass/fail metrics in real-time.
            </p>
          </div>
        </div>
      </div>
