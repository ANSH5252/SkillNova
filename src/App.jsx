...
import { 
  Activity, Zap, Briefcase, Search, Users, 
  Globe, ShieldCheck, Sparkles, Building2, ChevronRight, Lock, 
  Network, ArrowRight, User, CheckCircle, Target, Mail, ArrowUpRight, Github, Linkedin, Twitter, LogIn
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#04060d] text-slate-200 font-sans selection:bg-indigo-500/30 overflow-x-hidden flex flex-col relative">
      ...
      <div className="fixed top-4 md:top-6 w-full z-50 px-4 md:px-8 flex justify-center animate-fade-in delay-nav transition-all pointer-events-none">
        <nav className="w-full max-w-4xl bg-[#0a0f1c]/80 backdrop-blur-2xl border border-white/10 rounded-full px-6 py-3 flex items-center justify-between shadow-[0_8px_32px_rgba(0,0,0,0.5)] pointer-events-auto transition-all hover:bg-[#0a0f1c]/95">
          ...
          {/* 2. Center - Navigation Links (Equi-spaced) */}
      ...
      <section id="portals" className="relative pt-48 pb-20 px-6 flex-grow flex flex-col items-center justify-center min-h-[90vh]">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 w-full animate-fade-in-up delay-100">
          ...
          <div className="relative flex items-center p-1.5 bg-[#0a0f1c]/80 backdrop-blur-xl border border-white/10 rounded-full mb-12 mx-auto w-full max-w-[360px] md:max-w-[480px] shadow-[0_8px_32px_rgba(0,0,0,0.5)] overflow-hidden">
            <div 
              className={`absolute top-1.5 bottom-1.5 left-1.5 w-[calc(33.333%-4px)] rounded-full border transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] ${getSliderTranslate()} ${getSliderColor()}`}
            ></div>
          ...
          <div key={persona} className="animate-tab-switch min-h-[220px]">
            ...
            <div className="flex justify-center">
              <Link 
                ...
                className={`px-8 py-4 text-white rounded-2xl font-bold text-lg transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105 ${activeContent.btnClass}`}
              >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
              ...
              <div className="text-center group flex flex-col items-center">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h4 className="text-3xl md:text-4xl font-black text-white">&lt; 1s</h4>
                </div>
              ...
              <div className="text-center group flex flex-col items-center">
                <div className="flex items-center gap-2 mb-1">
                  <Target size={24} className="text-purple-400 group-hover:scale-110 transition-transform"/>
                  <h4 className="text-3xl md:text-4xl font-black text-white">99%</h4>
                </div>
              ...
              <div className="text-center group flex flex-col items-center">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h4 className="text-3xl md:text-4xl font-black text-white">Local</h4>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-8 bg-gradient-to-br from-[#0f172a] to-[#04060d] border border-white/[0.08] p-8 md:p-12 rounded-3xl hover:border-indigo-500/50 hover:shadow-[0_0_40px_rgba(99,102,241,0.1)] transition-all duration-500 relative overflow-hidden group">
              ...
              <div className="hidden sm:flex absolute top-8 right-8 items-center gap-2 px-3 py-1.5 bg-[#0a0f1c]/80 backdrop-blur-md border border-white/10 rounded-lg shadow-xl transform group-hover:-translate-y-1 transition-transform duration-500">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
                <span className="text-xs font-bold text-slate-300">ATS Score: 94%</span>
              </div>

              <div className="relative z-10">
                <div className="w-16 h-16 bg-indigo-500/10 border border-indigo-500/20 rounded-2xl flex items-center justify-center mb-8 shadow-inner">
                ...
                <p className="text-slate-400 leading-relaxed text-lg max-w-lg mb-8">
                  We don't sugarcoat it. Upload your PDF and let our ultra-fast Groq engine brutally penalize missing keywords, calculate your Market Probability, and map out your exact technical gaps.
                </p>
            ...
            <div className="md:col-span-4 bg-gradient-to-bl from-[#0f172a] to-[#04060d] border border-white/[0.08] p-8 md:p-10 rounded-3xl hover:border-purple-500/50 hover:shadow-[0_0_40px_rgba(168,85,247,0.1)] transition-all duration-500 relative overflow-hidden group flex flex-col justify-between">
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 bg-purple-500/10 border border-purple-500/20 rounded-2xl flex items-center justify-center mb-6 shadow-inner">
                ...
                <p className="text-slate-400 leading-relaxed text-base">
                  Paste any job description from LinkedIn or Indeed. The AI extracts core requirements and scores your resume specifically against that exact role.
                </p>
              </div>

              <div className="relative z-10 mt-8 flex items-center gap-2 text-xs font-medium text-slate-500 bg-[#0a0f1c] w-fit px-3 py-1.5 rounded-lg border border-slate-800">
                <span className="text-purple-400 font-bold">10/10</span> Keywords Matched
              </div>
            </div>
             ...
             <div className="md:col-span-5 bg-gradient-to-tr from-[#0f172a] to-[#04060d] border border-white/[0.08] p-8 md:p-10 rounded-3xl hover:border-emerald-500/50 hover:shadow-[0_0_40px_rgba(16,185,129,0.1)] transition-all duration-500 relative overflow-hidden group">
               ...
               <div className="relative z-10">
                <div className="w-14 h-14 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl flex items-center justify-center mb-6 shadow-inner">
                ...
                <p className="text-slate-400 leading-relaxed text-base mb-8 pr-12">
                  Verified high-match candidates who opt-in are pushed directly to the dashboard of enterprise hiring partners looking for exact skills.
                </p>
                <Link to="/login" state={{ intendedPath: '/employer' }} className="text-sm font-bold text-emerald-400 hover:text-emerald-300 flex items-center gap-1 transition-colors w-fit group-hover:translate-x-1 duration-300">
                  Explore Employer Portal <ChevronRight size={16}/>
                </Link>
              </div>
            </div>
            ...
            <div className="md:col-span-7 bg-gradient-to-tl from-[#0f172a] to-[#04060d] border border-white/[0.08] p-8 md:p-12 rounded-3xl hover:border-amber-500/50 hover:shadow-[0_0_40px_rgba(245,158,11,0.1)] transition-all duration-500 relative overflow-hidden group">
              ...
              <div className="hidden sm:flex absolute top-10 right-10 items-end gap-1.5 opacity-50 group-hover:opacity-100 transition-opacity duration-500">
                 <div className="w-3 h-6 bg-amber-500/20 rounded-t-sm"></div>
                 <div className="w-3 h-10 bg-amber-500/40 rounded-t-sm"></div>
                 <div className="w-3 h-14 bg-amber-500/60 rounded-t-sm"></div>
                 <div className="w-3 h-20 bg-amber-500/80 rounded-t-sm group-hover:bg-amber-400 transition-colors"></div>
              </div>

              <div className="relative z-10">
                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-400 text-[10px] font-bold uppercase tracking-widest mb-6 shadow-sm">
                  <Building2 size={12} /> University Partners
                </div>
                <h3 className="text-3xl font-bold text-white mb-4 tracking-tight">Cohort Intelligence Dashboard</h3>
                <p className="text-slate-400 leading-relaxed text-lg max-w-lg mb-8">
                  Universities can securely provision student accounts via CSV bulk-upload. Admins receive real-time analytics on curriculum skill gaps, at-risk students, and overall placement probability.
                </p>
                <Link to="/apply" className="px-6 py-3 bg-[#0a0f1c] hover:bg-slate-900 border border-slate-800 text-white rounded-xl font-bold text-sm transition-all inline-flex items-center gap-2 shadow-lg group-hover:-translate-y-1 duration-300">
                  Partner with SkillNova
                </Link>
              </div>
            </div>
      ...
      <footer id="about" className="relative z-10 bg-[#020308] pt-24 pb-10 mt-auto border-t border-white/5 overflow-hidden">
        ...
        {/* Massive Background Glow for Footer */}
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="mb-24 flex flex-col md:flex-row items-center justify-between gap-10 bg-gradient-to-r from-slate-900 to-[#0a0f1c] border border-white/10 p-10 md:p-14 rounded-3xl shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 flex-shrink-0">
               <Link to="/login" className="px-10 py-5 bg-white text-[#04060d] hover:bg-slate-200 rounded-full font-black text-lg transition-transform hover:scale-105 shadow-[0_0_40px_rgba(255,255,255,0.15)] flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="flex items-center gap-2 max-w-sm">
                ...
                <button className="bg-indigo-600 hover:bg-indigo-500 text-white px-4 py-2.5 rounded-lg text-sm font-bold transition-colors">
                  Join
                </button>
              </div>
            </div>
